...
function Numbers({}: Props) {
  return (
    <div className='flex relative flex-col text-center md:text-left xl:flex-row max-w-[2000px] xl:scroll-px-10 min-h-screen justify-center xl-space-y-0 mx-auto items-center bg-[#FBEAEB]'>
